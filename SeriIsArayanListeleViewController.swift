//
//  SeriIsArayanListeleViewController.swift
//  vankentrehberi
//
...
class SeriIsArayanListeleViewController: UIViewController , UITableViewDataSource, UITableViewDelegate ,InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        var urlString = "http://vankent.net/van_kent/web/api/seri/isarayan?page=" + String(pageCount)
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myCell", for: indexPath) as! SeriIsArayanTableViewCell
        
        cell.adiLbl.text  = adlar[indexPath.row]
        cell.telefonLbl.text = telefonlar[indexPath.row]
