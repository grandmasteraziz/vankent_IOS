...
public class InternetViewIndicator {
    ...
    private func initializer(backgroundColor:UIColor = UIColor.red, style: MessageView.Layout = .StatusLine, textColor:UIColor = UIColor.white, message:String = "Lütfen, internet bağlantınızı kontrol edin!", remoteHostName: String = "vankent.net", hideButton:Bool = true) {
