//
//  OtoSatilikListeleViewController.swift
//  vankentrehberi
//
...
class OtoSatilikListeleViewController: UIViewController ,UITableViewDataSource , UITableViewDelegate , InternetStatusIndicable {
