//
//  EmlakKiralikListeleViewController.swift
//  vankentrehberi
//
...
class EmlakKiralikListeleViewController: UIViewController , UITableViewDataSource, UITableViewDelegate , InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        var urlString = "http://vankent.net/van_kent/web/api/emlak/kiralik?page=" + String(pageCount)
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myCell", for: indexPath) as! EmlakKiralikTableViewCell
