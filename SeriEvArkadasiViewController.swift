//
//  SeriEvArkadasiViewController.swift
//  vankentrehberi
//
...
class SeriEvArkadasiViewController: UIViewController, UITableViewDataSource , UITableViewDelegate ,InternetStatusIndicable {
    ...
    override func viewDidLoad() {
        ...
        var urlString = "http://vankent.net/van_kent/web/api/seri/evarkadasi?page=" + String(pageCount)
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "myCell", for: indexPath) as! SeriEvArkadasiTableViewCell
